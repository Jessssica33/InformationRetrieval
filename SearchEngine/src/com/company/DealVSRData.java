...
public class DealVSRData {
    ...
    public TreeMap<String, Double> SortedHashMap(HashMap<String, Double> hmap) {
    ...
    public HashMap<String, Double> CalCosSim(ArrayList<String> query, String[] dnames,
        ...
        double queryWeightSquare = GetQueryWeightSquare(dnames.length, query, id, table);
        double weight = 0.0;
        double cs = 0.0;

        for (int i = 0; i < dnames.length; ++i) {
        //for (int i = 0; i < collectionWeightSquare.size(); ++i) {
